...
const createInnerHtml = () => {
    ...
    for (const employeePayrollData of employeePayrollList) {
        ...
        <tr>
            ...
            <td>
                <img id="${employeePayrollData._id}" onclick="remove(this)" alt="delete" src="C:\Users\Admin\Desktop\EmployeePayrollApp\Asserts\Icons\delete-black-18dp.svg>
                <img id="${employeePayrollData._id}" alt="edit" onclick="update(this)" src="C:\Users\Admin\Desktop\EmployeePayrollApp\Asserts\Icons\create-black-18dp.svg>
            </td>
        </tr>
        `;
    }
...
const createEmployeePayrollJSON = () => {
    let employeePayrollListLocal = [{
            ...
            _startDate: "18/07/2020, 12:00:00 AM"
        },
        {
            _id: new Date().getTime() ,
            _name: "Swathi",
            ...
            _startDate: "08/12/2020, 12:00:00 AM"
        }
    ];
